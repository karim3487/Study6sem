...
INSERT INTO patient_kkr VALUES(3, 'Алексей', 'Петров', 'ул. Гагарина, д.3', 'Екатеринбург', 3);
INSERT INTO patient_kkr VALUES(4, 'Ольга', 'Смирнова', 'ул. Мира, д.4', 'Новосибирск', 1);
INSERT INTO patient_kkr VALUES(5, 'Дмитрий', 'Козлов', 'ул. Лермонтова, д.5', 'Ростов-на-Дону', 2);
INSERT INTO patient_kkr VALUES(6, 'Мария', 'Волкова', 'ул. Горького, д.6', 'Самара', 3);
INSERT INTO patient_kkr VALUES(7, 'Сергей', 'Петров', 'ул. Ленинградская, д.7', 'Казань', 1);
INSERT INTO patient_kkr VALUES(8, 'Анна', 'Иванова', 'ул. Чехова, д.8', 'Воронеж', 2);
INSERT INTO patient_kkr VALUES(9, 'Игорь', 'Сидоров', 'ул. Крымская, д.9', 'Краснодар', 3);
INSERT INTO patient_kkr VALUES(10, 'Евгений', 'Федоров', 'ул. Советская, д.10', 'Саратов', 1);
...
INSERT INTO doctor_appointment_kkr (app_date, app_time, doc_id, pat_id) VALUES ('2023-04-10', '10:00:00', 1, 2);
INSERT INTO doctor_appointment_kkr (app_date, app_time, doc_id, pat_id) VALUES ('2023-04-12', '13:30:00', 8, 4);
INSERT INTO doctor_appointment_kkr (app_date, app_time, doc_id, pat_id) VALUES ('2023-04-14', '15:45:00', 2, 3);
INSERT INTO doctor_appointment_kkr (app_date, app_time, doc_id, pat_id) VALUES ('2023-04-12', '13:30:00', 4, 1);
INSERT INTO doctor_appointment_kkr (app_date, app_time, doc_id, pat_id) VALUES ('2023-04-14', '15:45:00', 7, 7);
...
CREATE TABLE IF NOT EXISTS `hospital`.`bill_kkr` (
  ...
  INDEX `fk_bill_kkr_apponiment_kkr1_idx` (`app_id` ASC) VISIBLE,
...
INSERT INTO bill_kkr (bill_is_amount_insured, bill_datesent, bill_amount, bill_status, app_id)
VALUES (1, '2023-03-15', 250.00, 1, 1);

INSERT INTO bill_kkr (bill_is_amount_insured, bill_datesent, bill_amount, bill_status, app_id)
VALUES (1, '2023-03-20', 890.50, 0, 2);

INSERT INTO bill_kkr (bill_is_amount_insured, bill_datesent, bill_amount, bill_status, app_id)
VALUES (1, '2023-03-25', 230.00, 0, 3);

INSERT INTO bill_kkr (bill_is_amount_insured, bill_datesent, bill_amount, bill_status, app_id)
VALUES (1, '2023-04-01', 520.00, 1, 4);

INSERT INTO bill_kkr (bill_is_amount_insured, bill_datesent, bill_amount, bill_status, app_id)
VALUES (1, '2023-04-05', 750.00, 0, 5);
...
INSERT INTO payment_kkr (pay_date, pay_time, pay_amount, bill_id) VALUES('2022-03-15', '09:30:00', 1500.00, 1);
INSERT INTO payment_kkr (pay_date, pay_time, pay_amount, bill_id, ins_id) VALUES('2022-03-15', '12:45:00', 2000.00, 2, 1);
INSERT INTO payment_kkr (pay_date, pay_time, pay_amount, bill_id, ins_id) VALUES('2022-03-16', '14:00:00', 800.00, 3, 3);
INSERT INTO payment_kkr (pay_date, pay_time, pay_amount, bill_id) VALUES('2022-03-15', '09:30:00', 1500.00, 4);
INSERT INTO payment_kkr (pay_date, pay_time, pay_amount, bill_id) VALUES('2022-03-15', '09:30:00', 1500.00, 2);
